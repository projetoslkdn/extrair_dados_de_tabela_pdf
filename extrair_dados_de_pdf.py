...
#faz a leitura e o reconhecimento de todos os arquivos a serem tratados localizando pela extenção em dado diretório
direc = os.listdir('/home/krijs/Área de Trabalho/Henrique/tabela')
filelist = []
for file in direc:
